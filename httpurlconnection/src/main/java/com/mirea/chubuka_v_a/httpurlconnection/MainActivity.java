package com.mirea.chubuka_v_a.httpurlconnection;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regionTextView = (TextView) findViewById(R.id.textView2);
        cityTextView = (TextView) findViewById(R.id.textView3);
        countryTextView = (TextView) findViewById(R.id.textView4);
